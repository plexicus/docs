...
Scan container images and Kubernetes manifests for known CVEs and misconfigurations. Plexicus orchestrates the scanners; you bring the registry credentials.

- **Vulnerability Scanning** <br />
    Identify known vulnerabilities in your container images using Trivy, Grype, and Checkov.
