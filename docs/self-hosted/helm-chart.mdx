...
### 11.2 Connect the SCM from the Connectors page \{#self-hosted_helm-chart-scm-connect}
...
### 11.3 Add a repository \{#self-hosted_helm-chart-scm-add-repo}
...
### 11.4 Trigger a scan and view findings \{#self-hosted_helm-chart-scm-scan}
