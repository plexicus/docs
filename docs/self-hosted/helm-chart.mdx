...
:::note Chart version
Examples on this page assume chart **1.2.5** or later. For older deployments, contact **[engineering@plexicus.ai](mailto:engineering@plexicus.ai)** for migration guidance.
:::
