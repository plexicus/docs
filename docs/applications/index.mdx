...
# Creating an Application \{#applications_index-1}

Follow these steps to create a new application:

## 1. Access the Applications Page \{#applications_index-2}

- Navigate to the Applications page
- Click `Add Applications`
- View the list of configured SCM Connectors

## 2. Select SCM Connector \{#applications_index-3}
...
## 3. Select Repositories \{#applications_index-4}

- Choose one or more repositories to create applications
- Click `Create Selected Repositories`

<img
	src="/docs/plexicus/applications/repositories.png"
	alt="Manage Repositories Page"
/>

## 4. Branch Selection (If Applicable) \{#applications_index-5}

- If a repository has multiple branches, a modal will appear
- Select the desired branch(es)

<img
	src="/docs/plexicus/applications/modal-branches.png"
	alt="Applications Modal branches Page"
/>

## 5. BlackDuck Configuration (If Applicable) \{#applications_index-6}

- If BlackDuck is configured in the Connectors page, a modal will appear
  <img src="/docs/plexicus/blackduck/panel.png" alt="BlackDuck Page" />
- Enter the project name for BlackDuck
  <img src="/docs/plexicus/blackduck/form.png" alt="BlackDuck Form Page" />

## 6. Application Creation Process \{#applications_index-7}
...
<img
	src="/docs/plexicus/applications/item.png"
	alt="Applications Item Page"
/>

## 7. View Application Status \{#applications_index-8}
